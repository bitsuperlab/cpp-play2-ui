    ...
    render() {
        ...
        trx.operations.forEach((op, opIndex) => {
            ...
            switch (ops[op[0]]) { // For a list of trx types, see chain_types.coffee
                ...
                case "account_balance_migrate":
                  color = "success";

                    rows.push(
                        <tr key={key++}>
                            <td><Translate component="span" content="wallet.your_eth_address" /></td>
                            <td>{op[1].eth_address}</td>
                        </tr>
                    );

                    rows.push(
                        <tr key={key++}>
                            <td><Translate component="span" content="account.id" /></td>
                            <td>{this.linkToAccount(op[1].account)}</td>
                        </tr>
                    );
